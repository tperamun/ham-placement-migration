...
// +kubebuilder:rbac:groups=core.hybridapp.io,resources=deployers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.hybridapp.io,resources=deployers/status,verbs=get;update;patch
