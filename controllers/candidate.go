...
import (
	...
	corev1alpha1 "github.com/hybridapp-io/ham-placement/api/v1alpha1"
)
...
func (r *PlacementRuleReconciler) getTargetGVR(instance *corev1alpha1.PlacementRule) (*schema.GroupVersionResource, error) {
...
func (r *PlacementRuleReconciler) generateCandidates(instance *corev1alpha1.PlacementRule) ([]corev1.ObjectReference, error) {
	if instance == nil {
		return nil, nil
	}
